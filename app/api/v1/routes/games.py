...
@game_router.post("/initiate/{creator_id}", summary="Initiate a new game", status_code=201, response_model=GameInitiateResponse)
async def initiate_new_game_endpoint(creator_id: int, game_data: GameCreate, request: Request, session: Annotated[AsyncSession, Depends(get_database_session)]): #TODO: this should get creator_id from request, just for test
    try:
